 ...
 */
async function fillExcelTemplateMultiSheet(templatePath, commonData, perSheetData, outPath) {
  const workbook = new ExcelJS.Workbook();
  await workbook.xlsx.readFile(templatePath);
...
module.exports = { fillExcelTemplate, fillExcelTemplateMultiSheet, addImageBelowCell };
